...
const u16 gMetatiles_GameBoy[] = INCBIN_U16("data/tilesets/primary/game_boy/metatiles.bin");
const u32 gMetatileAttributes_GameBoy[] = INCBIN_U32("data/tilesets/primary/game_boy/metatile_attributes.bin");
